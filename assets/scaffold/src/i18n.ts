...
const es = {
  ...
  finished: "terminado",
  viewingPast: "Estás viendo un ciclo anterior.",
  backToCurrent: "Volver al actual",
  cycles: "Ciclos",
  cycleCols: { goal: "Objetivo", dates: "Fechas", status: "Estado", result: "Resultado", runs: "Corridas", km: "Km" },
  monthlyVolume: "Volumen por mes",
  monthlyVolumeSub: "Todas las corridas registradas, de todos los ciclos y entre ciclos.",
  allTime: (label: string) => `${label}, desde el principio`,
  allTimeSub: "Cada sesión con dato, a lo largo de todos los ciclos.",
  restingHrMonthly: "FC en reposo por mes",
  restingHrMonthlySub: "Promedio mensual. La tendencia larga importa más que un día.",
  upgradeNeeded: "Los datos de este atleta tienen un formato anterior. Corré /strata:upgrade para migrarlos.",
...
const en: Strings = {
  ...
  finished: "finished",
  viewingPast: "You're looking at a past cycle.",
  backToCurrent: "Back to current",
  cycles: "Cycles",
  cycleCols: { goal: "Goal", dates: "Dates", status: "Status", result: "Result", runs: "Runs", km: "Km" },
  monthlyVolume: "Monthly volume",
  monthlyVolumeSub: "Every logged run, across cycles and between them.",
  allTime: (label) => `${label}, all time`,
  allTimeSub: "Every session with a value, across all cycles.",
  restingHrMonthly: "Resting HR by month",
  restingHrMonthlySub: "Monthly average. The long trend matters more than any day.",
  upgradeNeeded: "This athlete's data is in an older format. Run /strata:upgrade to migrate it.",
